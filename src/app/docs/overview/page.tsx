      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            A decentralized lending platform allowing users to deposit assets and earn yield, or borrow against collateral with real-time metrics.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Supply crypto assets into lending pools to earn interest</li>
            <li>Borrow against your collateral with transparent interest rates</li>
            <li>Manage your positions with automated liquidation protection</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Real-time TVL and utilization rate tracking</li>
            <li>✓ Multi-asset support (USDC, ETH, USDT, DAI, WBTC)</li>
            <li>✓ Configurable LTV ratios per asset</li>
            <li>✓ Automated interest accrual</li>
            <li>✓ Liquidation thresholds with partial liquidation support</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Connect your wallet to view and interact with pools</li>
            <li>Deposit assets you want to lend</li>
            <li>Borrow against your collateral when needed</li>
          </ol>
        </section>
